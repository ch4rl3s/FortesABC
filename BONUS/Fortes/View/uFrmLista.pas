...
procedure TFrmLista.btnDeleteClick(Sender: TObject);
begin
  if Application.MessageBox('Deseja realmente excluir o registro?', 'Informativo', MB_YESNO + MB_ICONQUESTION) = IDYES then
  begin
